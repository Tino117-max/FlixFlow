...
import com.fixflow.security.UserDetailsServiceImpl;
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/solicitudes/**").hasAnyRole("ADMIN", "CLIENTE", "TECNICO")
                        .requestMatchers("/api/asignaciones/**").hasRole("ADMIN")
                        .requestMatchers("/api/diagnosticos/**").hasAnyRole("TECNICO", "ADMIN")
                        .requestMatchers("/api/reparaciones/**").hasAnyRole("TECNICO", "ADMIN")
